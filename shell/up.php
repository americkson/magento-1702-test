...
class Ash_Up_Shell_Installer extends Mage_Shell_Abstract
{
    ...
    protected function _displayAvailableExtensions()
    {
        ...
        $this->_renderExtensionList($collection);
    }
    ...
    protected function _renderExtensionList(Mage_Core_Model_Resource_Db_Collection_Abstract $extensions)
    {
        foreach ($extensions as $extension) {
            echo sprintf('%-30s', $extension->getExtensionName());
